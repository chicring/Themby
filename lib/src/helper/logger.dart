...
class ThembyLogger extends Logger {
  ThembyLogger._internal() : super();
  static final ThembyLogger _instance = ThembyLogger._internal();

  factory ThembyLogger() {
    return _instance;
  }
  ...
  void log(Level level, dynamic message,
    ...
    if (level == Level.error) {
      ...
      final String filename = p.join(logDir, "themby_logs.log");
